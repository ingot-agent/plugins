...
- Apply route and cache-capacity updates to the running counter immediately and
...
- Offer current providers as open suggestions for future-compatible routes and
  reject stale writes.
