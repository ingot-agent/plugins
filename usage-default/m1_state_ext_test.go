...
// untouched.
func withState(t *testing.T, cfg usagedefault.Config, deps usagedefault.Dependencies) usagedefault.Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg usagedefault.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg usagedefault.Config) {
	t.Helper()
