...
// untouched.
func withState(t *testing.T, cfg appbackend.Config, deps Dependencies) Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg appbackend.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg appbackend.Config) {
	t.Helper()
