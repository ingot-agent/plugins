...
func providerEntries(t *testing.T, exports openairesponses.Exports) []model.ProviderEntry {
	t.Helper()
...
// untouched.
func withState(t *testing.T, cfg openairesponses.Config, deps openairesponses.Dependencies) openairesponses.Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg openairesponses.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg openairesponses.Config) {
	t.Helper()
