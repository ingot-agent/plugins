...
// untouched.
func withState(t *testing.T, cfg promptdefault.Config, deps promptdefault.Dependencies) promptdefault.Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg promptdefault.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg promptdefault.Config) {
	t.Helper()
