...
// untouched.
func withState(t *testing.T, cfg openaicompat.Config, deps openaicompat.Dependencies) openaicompat.Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg openaicompat.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg openaicompat.Config) {
	t.Helper()
