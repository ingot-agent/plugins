...
// untouched.
func withState(t *testing.T, cfg agentdefault.Config, deps agentdefault.Dependencies) agentdefault.Dependencies {
	t.Helper()
...
func writeTestConfig(t *testing.T, cfg agentdefault.Config) string {
	t.Helper()
...
func persistTestConfig(t *testing.T, dir string, cfg agentdefault.Config) {
	t.Helper()
